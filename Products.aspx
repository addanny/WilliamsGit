...
&nbsp;<asp:LinkButton ID="linkTShirtAdd" runat="server" OnClick="linkTShirtAdd_Click" ForeColor="White">Add</asp:LinkButton>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;<asp:LinkButton ID="linkPlaqueAdd" runat="server" ForeColor="White">Add</asp:LinkButton>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
