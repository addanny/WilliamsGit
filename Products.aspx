...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
        ...
        <asp:Button ID="btnTShirtAdd" runat="server" OnClick="Button2_Click" Text="Buy" />
...
<asp:Label ID="lblTShirtWarning" runat="server" Font-Bold="True" ForeColor="#CC0000" Text="Warning Label" Visible="False"></asp:Label>
    ...
    <table class="auto-style2">
        ...
        <asp:Button ID="btnPlaqueAdd" runat="server" OnClick="Button1_Click" Text="Buy" />
&nbsp;<asp:Label ID="Label2" runat="server" Text="Qty:"></asp:Label>
&nbsp;<asp:TextBox ID="txtPlaqueQty" runat="server" Width="37px"></asp:TextBox>
